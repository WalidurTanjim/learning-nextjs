    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            ...
            <div className={`text-center`}>
                <p className={`text-sm text-gray-500`}>Already Have An Account? <Link href={`/sign-in`} className={`text-blue-500 hover:text-blue-700 active:text-blue-500`}>Sign In</Link></p>
            </div>
        </section>
    );
};
