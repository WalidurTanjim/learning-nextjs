    ...
    return (
        <div>
            ...
            <button
                ...
                type="button"
                className={`visible fixed right-6 lg:right-96 top-28 z-40 order-10 block h-10 w-10 self-center rounded bg-slate-700 opacity-100 ${
                    isSideNavOpen
          ...
          ></span>
            ...
            <aside
                id="nav-menu-2"
                aria-label="Side navigation"
                className={`fixed top-0 bottom-0 left-0 z-40 flex w-72 flex-col border-r border-r-slate-200 bg-white transition-transform ${
                        ...
                        <ul className="flex flex-1 flex-col gap-1 py-3">
                            ...
                            <li className="px-3">
                                ...
                                >
                                    ...
                                    <span
                                        className="inline-flex items-center justify-center rounded-full bg-emerald-100 px-2 text-xs text-emerald-500 ">
