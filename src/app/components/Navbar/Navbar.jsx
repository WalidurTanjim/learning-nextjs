...
const Navbar = () => {
    ...
    return (
        <Disclosure as="nav" className="bg-gray-800">
            <div className="mx-auto container px-6 lg:px-48">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div
...

                        {
                            ...
                            <Link href={`/sign-in`}><button type={"button"} className={`py-1.5 px-4 ml-3 rounded-md text-white text-sm bg-slate-700 hover:bg-slate-600 active:bg-slate-700`}>Sign In</button></Link>
                        }
                    </div>
                </div>
            </div>
